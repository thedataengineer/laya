...
export const BUNDLE_REPO = "thekarteek/taut";
...
export const STANDALONE_MODELS: Record<string, string> = {
  english: "thekarteek/taut",
  multilingual: "thekarteek/taut-multilingual",
  "typed-decisions": "thekarteek/taut-typed-decisions",
};
...
const ALIASES: Record<string, ModelName> = {
  ...
  multi: "multilingual",
  ml: "multilingual",
  "taut-multilingual": "multilingual",
  typed: "typed-decisions",
  typed_decisions: "typed-decisions",
  "taut-typed-decisions": "typed-decisions",
