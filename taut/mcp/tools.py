"""Thin tool layer over taut. Lay-a calls go through injectable hooks for tests."""
...
def taut_route(state: Any, questions: Any, *, router: Any = None) -> dict:
...
def taut_status(*, router: Any = None, loaded: list[str] | None = None, preload: bool = True) -> dict:
    ...
    # is loaded; before any load it is the configured preference (TAUT_DEVICE
