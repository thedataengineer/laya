...
Run: python research/eval/test_taut_eval.py
"""
import os
import random
import sys
...
from research.eval.taut_eval import (  # noqa: E402
...
# `taut.common.ece_score`, `research/scripts/bench_local.py` and
...
_fa = _FakeAgent()
from taut.common import QTYPES  # noqa: E402
